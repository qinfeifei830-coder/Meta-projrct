...
age.model2 <- rma.mv(G, ViG, slab = author, mods = ~ factor(age_coded), random = ~ 1 | studyid,  test = "t", method = "REML", data=my_data)
age.model2

age.model2 <- rma.mv(G, ViG, slab = author, mods = ~ factor(age_coded)-1, random = ~ 1 | studyid,  test = "t", method = "REML", data=my_data)
age.model2

Per_session_exercise_duration.model2 <- rma.mv(G, ViG, slab = author, mods = ~ factor(Per_session_exercise_duration_coded), random = ~ 1 | studyid,  test = "t", method = "REML", data=my_data)
Per_session_exercise_duration.model2

Per_session_exercise_duration.model<- rma.mv(G, ViG, slab = author, mods = ~ factor(Per_session_exercise_duration_coded)- 1, random = ~ 1 | studyid,  test = "t", method = "REML", data=my_data)
Per_session_exercise_duration.model

Frequency.model2 <- rma.mv(G, ViG, slab = author, mods = ~ factor(Frequency_coded), random = ~ 1 | studyid,  test = "t", method = "REML", data=my_data)
Frequency.model2

Frequency.model <- rma.mv(G, ViG, slab = author, mods = ~ factor(Frequency_coded) - 1, random = ~ 1 | studyid,  test = "t", method = "REML", data=my_data)
Frequency.model

Exercise_time_per_week.model2<- rma.mv(G, ViG, slab = author, mods = ~ factor(Exercise_time_per_week_coded), random = ~ 1 | studyid,  test = "t", method = "REML", data=my_data)
Exercise_time_per_week.model2

Exercise_time_per_week.model<- rma.mv(G, ViG, slab = author, mods = ~ factor(Exercise_time_per_week_coded) - 1, random = ~ 1 | studyid,  test = "t", method = "REML", data=my_data)
Exercise_time_per_week.model

int_weeklyvolume.model2<- rma.mv(G, ViG, slab = author, mods = ~ factor(int_weeklyvolume_coded), random = ~ 1 | studyid,  test = "t", method = "REML", data=my_data)
int_weeklyvolume.model2

int_weeklyvolume.model<- rma.mv(G, ViG, slab = author, mods = ~ factor(int_weeklyvolume_coded) - 1, random = ~ 1 | studyid,  test = "t", method = "REML", data=my_data)
